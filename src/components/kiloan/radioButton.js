...
export default class RadioButtons extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            checked: 0,
            dataBaru: [
                {name: 'PAKET CUCI SETRIKA', text: '*Paket laundry lengkap mulai dari proses pencucian, pengeringan, dan proses setrika pakaian.'},
                {name: 'PAKET SETRIKA', text: '*Paket laundry hanya proses setrika pakaian.'},
                {name: 'PAKET CUCI KERING', text: '*Paket laundry hanya proses pencucian sampai pengeringan pakaian.'}
            ]
        }
    }
