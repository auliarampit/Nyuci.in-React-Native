...
import Paket from '../components/bayi/radioButton'
import RadioWaktu from '../components/bayi/radioWaktu'
            ...
            <View style={cs.container}>
                ...
                <ScrollView>
                    <View style={cs.view1}>
                        <View style={{flexDirection: 'row', marginTop: 10}}>
                            ...
                            <View>
                                <Text style={cs.textjudul}>LAUNDRY PAKAIAN BAYI</Text>
                                <Text style={cs.texttitle}>Cuci Tangan</Text>
                            </View>
                        </View>
                        <Paket />
                    </View>
                ...
                <View style={cs.footerbtn}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 15}}>
                        ...
                        <TouchableOpacity style={cs.btn2}  onPress={() => this.props.navigation.navigate('DetailBayi')}>
