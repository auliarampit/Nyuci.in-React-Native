                        ...
                        <View style={styles.view1}>
                            <View style={{flexDirection: 'row', marginTop: 10}}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.texttitle}>PAKET SEPATU</Text>
                                </View>
                            </View>
                            ...
                            <View style={{marginHorizontal: 20}}>
                                ...
                                <View style={{flexDirection: 'row'}}>
                                    <View style={{flex: 1.5}}>
                                        <Text style={styles.data}>DEEP CLEAN HARD @1 PCS</Text>
                                    </View>
                            ...
                            <View style={{flex: 1}}>
                                <View style={{flexDirection: 'row', marginTop: 10}}>
                                    <View style={styles.textPerkiraan}>
                                        <Text style={styles.perkiraan}>TOTAL HARGA</Text>
                                ...
                                <View style={{marginBottom: 15,marginHorizontal: 20, marginTop: 5}}>
                                    <Text style={styles.note}>HARAP MELAKUKAN PEMBAYARAN DI AWAL KETIKA PICKUP SEPATU!</Text>
                                </View>
                            </View>
                        </View>
