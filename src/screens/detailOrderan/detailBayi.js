...
class OrderanBayi extends Component {
                    ...
                    <View style={styles.content}>
                        <View style={styles.view1}>
                            <View style={{flexDirection: 'row', marginTop: 10}}>
                                ...
                                <View>
                                    <Text style={styles.textjudul}>PAKET CUCI SETRIKA</Text>
                                    <Text style={styles.texttitle}>PAKET 2 HARI</Text>
                                </View>
                            </View>
                        ...
                        <View style={styles.view2}>
                            ...
                            <View style={{marginBottom: 20}}>
                                ...
                                <Text style={styles.note3}>- harga fix laundry akan di hitung ketika petugas kami menimbang berat cucian di lokasi.</Text>
                            </View>
                        </View>
                    </View>
                </ScrollView>
                <View style={styles.footerbtn}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 15}}>
                        ...
                        <TouchableOpacity onPress={() => {alert('Sedang Proses')}} style={styles.btn2}>
                            <Text style={styles.textBtn}>Oder Laundry</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
